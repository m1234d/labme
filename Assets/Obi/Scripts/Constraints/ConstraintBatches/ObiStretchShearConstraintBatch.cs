...
public class ObiStretchShearConstraintBatch : ObiConstraintBatch
{
	...
	public void AddConstraint(int index1, int index2, float restLength, Vector3 stiffness){
	...
	public void InsertConstraint(int constraintIndex, int index1, int index2, float restLength, Vector3 stiffness){
	...
	public override void PushDataToSolver(ObiBatchedConstraints constraints){ 
		...
		Oni.SetStretchShearConstraints(batch,solverIndices,orientationIndices,solverRestLengths,solverStiffnesses,ConstraintCount);
	}
